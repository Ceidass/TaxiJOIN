...
function usr_check(){
	usr.onkeyup = function(){
		...
		usr_ajax.open("POST","php/handler.php",true);
        usr_ajax.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		usr_ajax.send("action=usernameCheck&usr=" + usr.value);
